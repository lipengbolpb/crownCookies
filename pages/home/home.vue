<template>
	...
	<view class="homeWrap">
		<!-- 青岛啤酒辽宁 -->
		<view class="status_bar" :style="[{'height': customBarH + 'px', 'padding-top': statusBarH + 'px','line-height':customBarH - statusBarH + 'px'}]"></view>
		...
		<view class="index" v-if="openid || needLocation">
			...
			<view class="account">
				<view class="left">
					<view class="num">
						<view class="data"><text>{{total}}</text>瓶</view>
						<view class="line"></view>
						<view class="tit">总计喝了</view>
					</view>
				</view>
				<view class="center">
					<button  class="user" open-type="getUserInfo" @getuserinfo="getUserInfoFn"
					 withCredentials="true">
						<image class="avatar" :src="userInfo.avatarUrl || imgUrl + '2.0/avatar.png'"></image>
					</button>

					<view class="num">
						<view class="data"><text>{{userScanMonthCount}}</text>瓶</view>
						<view class="line"></view>
						<view class="tit">本月累计喝了</view>
					</view>
				</view>
				<view class="right">
					<view class="num">
				...
				<!-- 关注公众号 height: 300px;--> 
				<movable-area style="height: 120px;width: 150px;position: absolute; right: 0;z-index:2">
				  <!--粉色任意方向拖动-->
				  <movable-view direction="all" style="width: 150rpx;background:transparent ;">
					  <!-- 客服消息 -->
					  <button class="kefuBtn" open-type="contact" send-message-title="畅享青啤" :send-message-path="sharePath"
					  	  ...
					  	  <image :src=" imgUrl + '2.0/kefu.png' " mode="widthFix" class="kefu"></image>
					  </button>
				  </movable-view>
				</movable-area>
			...
			<!-- 扫码有礼 -->
			<image :src=" imgUrl + '2.0/scanGift.png'" mode="widthFix" class="scanGift" @click="scanGetInfo"></image>
			<!-- 模块 -->
			<view class="mode">
				<image :src=" imgUrl + '2.0/story.png' " mode="widthFix" class="item" @click="brandStory"></image>
				<image :src=" imgUrl + '2.0/order.png' " mode="widthFix" class="item" @click="proBuy"></image>
				<image :src=" imgUrl + '2.0/active.png' " mode="widthFix" class="item" @click="brandActive"></image>
				<image :src=" imgUrl + '2.0/game.png' " mode="widthFix" class="item" @click="game"></image>
			</view>
		</view>
	</view>
